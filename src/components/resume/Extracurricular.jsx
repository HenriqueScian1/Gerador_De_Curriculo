  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        <h3 className="text-lg font-semibold text-gray-900">Atividades e Conquistas Extracurriculares</h3>
        <button
          onClick={handleAdd}
        ...
        >
          <div className="flex justify-between items-start">
            <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-700">Título/Conquista</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700">Data/Duração</label>
                <input
                  type="text"
                  value={activity.date}
      ...
      {activities.length === 0 && (
        <div className="text-center py-4 text-gray-500">
          Nenhuma atividade adicionada ainda. Clique em "Adicionar Atividade" para começar.
        </div>
      )}
    </div>
  );
